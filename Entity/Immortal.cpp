...
si::entity::Immortal::Immortal(const si::entity::Size& size, const si::entity::Position& position, unsigned int attack_points,
...
void si::entity::Immortal::collide(unsigned int damage) {/* Do nothing as damage is irrelevant*/}
